...
function Markets() {
  ...
  return (
    <div className="space-y-6">
        <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-center md: justify-between rounded-2xl bg-white p-6 border border-slate-200 shadow-xs">
            <div>
                <h1 className="text-2xl font-bold text-slate-900 tracking-tight">Tüm Piyasalar</h1>
                <p className="mt-1 text-sm text-slate-500 ">
                    Döviz kurları ve Altın/Gümüş fiyatları tablosu
                </p>
            </div>
