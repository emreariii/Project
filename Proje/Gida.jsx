    ...
    <div className="flex">
      ...
      <div className="h-full w-full flex flex-col p-4 gap-4">
        <div className="flex flex-row gap-x-4">
          ...
          <div className="text-black font-bold text-lg py-1">GIDA</div>
        </div>
          ...
          <div className=" p-10 gap-x-20 flex flex-row justify-center items-center">
            <div className="h-20 w-50 bg-white border border-gray-200 rounded-2xl shadow-sm">
              <div className="flex flex-col h-full w-full p-3 gap-2">
                ...
                <div className="text-slate-900 font-bold text-2xl">%42.92</div>
              </div>
            </div>
            <div className="h-20 w-50 bg-white border border-gray-200 rounded-2xl shadow-sm">
              <div className="flex flex-col h-full w-full p-3 gap-2">
                ...
                <div className="text-slate-900 font-bold text-2xl">173/403</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="flex flex-row justify-center">
          <ul className="w-full border border-gray-200 rounded-l-2xl">
            ...
            <li className="bg-white h-10 border border-gray-200 p-1">
              <div className="text-black font-semibold text-lg">
                Çikolatalı Gofret (Kutu)
              </div>
            </li>
            <li className="bg-white h-10 border border-gray-200 p-1">
              <div className="text-black font-semibold text-lg">
                Karışık Kuruyemiş (250g Paket)
              </div>
            </li>
            <li className="bg-white h-10 border border-gray-200 p-1">
              <div className="text-black font-semibold text-lg">
            ...
            <li className="bg-white h-10 border border-gray-200 p-1">
              <div className="text-black font-semibold text-lg">
                Hazır Çorba (Tek Kullanımlık/Paket)
              </div>
            </li>
            <li className="bg-white h-10 border border-gray-200 p-1">
              <div className="text-black font-semibold text-lg">
            ...
            <li className="bg-white h-10 border border-gray-200 p-1">
              <div className="text-black font-semibold text-lg">Muz (Kilo)</div>
            </li>
            <li className="bg-white h-10 border border-gray-200 p-1">
              <div className="text-black font-semibold text-lg">
                Form Pirinç Patlağı (Paket)
              </div>
            </li>
            <li className="bg-white h-10 border border-gray-200 p-1">
              <div className="text-black font-semibold text-lg">
